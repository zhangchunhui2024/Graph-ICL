...
def main():
    ...
    # 构建文件路径
    file_path1 = f"/home/zch/Code/GraphICL/result/GraphInstruct/DeepSeek/test3/responses/responses_{result_file}.json"
    ...
    # 构建文件路径
    file_path2 = f'/home/zch/Code/GraphICL/result/GraphInstruct/DeepSeek/test3/task_accuracies/task_accuracies_{result_file}.txt'
