...
def main():
    ...
    filename = f'/home/zch/Code/GraphICL/result/GraphInstruct/Qwen2.5-7B/responses_with_context_all_tasks/responses_with_context_all_tasks_{context_size}_{template_icl}_{timestamp}.json'
