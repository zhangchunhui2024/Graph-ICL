...
def prepare_input_boxed(template, input_d):
    ...
    # 如果response超过30000字符，保留最后30000字符
...
def main():
    ...
    # 构建文件路径
    file_path1 = f"/home/zch/Code/GraphICL/result/GraphInstruct/Qwen3-14B/responses/responses_{result_file}.json"
    ...
    # 构建文件路径
    file_path2 = f'/home/zch/Code/GraphICL/result/GraphInstruct/Qwen3-14B/task_accuracies/task_accuracies_{result_file}.txt'
