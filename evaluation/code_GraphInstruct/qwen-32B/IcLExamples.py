...
def load_config_from_json(filename='config.json', item=None):
        with open(filename, 'r') as file:
            ...
            elif item == 'task_types':
                return config.get('task_types', None)
...
def main():
    ...
    task_types = load_config_from_json(item='task_types')  
    ...
    for task_type in task_types:
        ...
        filename = f'/home/zch/Code/GraphICL/result/GraphInstruct/QwQ-32B/test1/responses_with_context_all_tasks/responses_with_context_all_tasks_{task_type}_{context_size}_{template_icl}_{timestamp}.json'
