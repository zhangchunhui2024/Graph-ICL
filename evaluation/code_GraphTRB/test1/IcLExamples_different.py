...
def main():
    ...
    for graph_type in graph_types:
        ...
        for task_type in task_types:
            ...
            if task_type == question:
                continue
            # 直接从预处理的数据结构中获取 filtered_examples
            filtered_examples = preprocessed_data[task_type].get(graph_type, [])
            # 检查 filtered_examples 是否为空列表
    ...
    filename = f'/home/zch/Code/GraphICL/result/GraphTRB/responses_with_context_all_tasks/responses_with_context_all_tasks_{question}_{template_icl}_{timestamp}.json'
