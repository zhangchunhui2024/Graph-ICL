...
def main():
    ...
    filename = f'/home/zch/Code/GraphICL/result/GraphTRB/responses_with_context_all_tasks/responses_with_context_all_tasks_same_{template_icl}_{timestamp}.json'
