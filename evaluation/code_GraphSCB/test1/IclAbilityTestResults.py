...
def main():
    ...
    # 构建文件路径
    file_path1 = f"/home/zch/Code/GraphICL/result/GraphSCB/responses/responses_{timestamps}.json"
    ...
    # 构建文件路径
    file_path2 = f'/home/zch/Code/GraphICL/result/GraphSCB/task_accuracies/task_accuracies_{timestamps}.txt'
