...
def main():
    ...
    # 构建文件路径
    file_path1 = f"/home/zch/Code/GraphICL/result/GraphSCB/test4/responses_with_context_all_tasks/responses_with_context_all_tasks_{result_file}.json"
    ...
    # 构建文件路径
    file_path2 = f'/home/zch/Code/GraphICL/result/GraphSCB/test4/ICLtask_accuracies/ICLtask_accuracies_{result_file}.txt'
