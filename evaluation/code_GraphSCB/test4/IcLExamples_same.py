...
def main():
    ...
    filename = f'/home/zch/Code/GraphICL/result/GraphSCB/test4/responses_with_context_all_tasks/responses_with_context_all_tasks_same_{context_size}_{template_icl}_{timestamp}.json'
